    ...
    function update(){
      ...
      if (trimesterInfo.x< 21){trimesterInfo.vx += 1;}
      if (trimesterInfo.x >= 23){ trimesterInfo.vx = 0; trimesterInfo.x = 25 }
      ...
      // // if(true){
      //   console.log("application timed out");
      //   clearInterval(round);
      // }
    }
    ...
    function drawLengthWeight(context) {
      ...
      context.fillText( GlobalWeeksElapsed + ((GlobalWeeksElapsed === 1) ? " Week Completed" : " Weeks Completed" ), 515, 50);
